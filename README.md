...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-sendgrid-android-v0.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-sendgrid-android-v0)

This repository contains the source code for the [sendgrid](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.sendgrid.android.v0).

Please see the [issues](https://github.com.sendgrid.android.v0/com-sendgrid-android-v0/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about sendgrid? Ask away on the [com-sendgrid-android-v0 discussion forum](https://groups.google.com/forum/#!forum/com-sendgrid-android-v0).

<a href="https://play.google.com/store/apps/details?id=com.sendgrid.android.v0" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.sendgrid.android.v0__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.sendgrid.android.v0__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.sendgrid.android.v0.R__) will now be renamed
...
signed with a different key.  Manually uninstall sendgrid from your device and
...
sendgrid is a result of a template project I've developed over the years as well as
...
sendgrid is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.sendgrid.android.v0/com-sendgrid-android-v0/contributors) on
...
[pull requests](https://github.com.sendgrid.android.v0/com-sendgrid-android-v0/pulls).
